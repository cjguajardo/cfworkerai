...
const model = provider.embedding( 'cfworkerai-embed' );

describe( 'doEmbed', () => {
  const server = new JsonTestServer( process.env.CF_BASE_URL + '/embeddings' );
  ...
  it( 'should pass headers', async () => {
    ...
    await provider.embedding( 'cfworkerai-embed' ).doEmbed( {
      values: testValues,
      headers: {
